...
def plot_potencial(j,l,r,R,a,V0neutron,r_0,V0proton):
    ...
    ax[0].plot(r,columb(r,Z,R) + woodsaxon(r,R,a,V0proton) + scalarLS(j,l,r,R,a,V0proton,r_0), color='g', label="Wood-Saxon + Coulomb potenciál + Spin-Orbit")
    ax[0].set_xlabel("r[fm]")
    ax[0].set_ylabel("V[MeV]")
    ax[0].legend(loc=0)
    ax[0].set_title("Proton potenciál V(r), l=%s"%l + " j=%s"%j)

    ax[1].plot(r,woodsaxon(r,R,a,V0neutron), color='y', label="Wood-Saxon potenciál")
...
for i in range(len(l1)):
    ...
    print('----------------------------------------------------------------------------------------')
    print('Orbital angular momenta l: %s'%l1[i] + '\nTotal angular momentum j: %s \n'%j1[i])
